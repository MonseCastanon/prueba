...
public class CatProductoServiceImpl implements CatProductoService {
    ...
    public CatProductoResponse obtenerCatalogo() {
        ...
        try {
            ...
            if (lista == null || lista.isEmpty()) {
                log.warn("[CONSULTA] No se encontraron productos en MongoDB");
    ...
    public void sincronizarCatalogoDesdeGp() {
        log.info("[SINCRONIZACIÓN] Iniciando descarga y sincronización de catProduct GP");
        ...
        try {
            ...
            if (xmlDto == null || xmlDto.getProductos() == null) {
            ...
            log.info("[SINCRONIZACIÓN ÉXITO] Se sincronizaron {} productos en MongoDB correctamente", documentos.size());
